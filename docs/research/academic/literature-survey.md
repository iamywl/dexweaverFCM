...
- **[FCM 한계 개선을 위한 학술 연구 동향](fcm-improvement-approaches.md)**: 본 문서의 조사 결과를 바탕으로, FCM 한계를 개선하기 위한 학계의 6대 접근 방향(MQTT QoS 보강, App-Level ACK, OEM 대응, Edge Computing, RL 기반 최적화, 보안 강화)을 22편의 추가 논문과 함께 정리한 문서.
- **[FCM 등장 배경과 기술적 한계](../fcm/history-and-limitations.md)**: Polling → C2DM → GCM → FCM 진화 과정과 FCM의 10가지 기술적 한계를 정리한 문서.
